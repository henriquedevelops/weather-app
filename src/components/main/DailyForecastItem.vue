...
const backgroundColor = computed(() => {
  return getTemperatureColor(props.temperature) ?? undefined
})
</script>
...
<template>
  ...
  <article v-else class="day-item" :style="{ backgroundColor }">
    ...
    <div class="day-item__info">
      ...
      <p class="day-item__condition">{{ condition }}</p>
    </div>
    <data class="day-item__temp" :value="temperature" aria-label="Temperature"
      >{{ temperature }}°C</data
    >
  </article>
</template>
